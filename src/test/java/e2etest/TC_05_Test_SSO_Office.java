...
public class TC_05_Test_SSO_Office {
    ...
    public void classSetup() throws IOException {
        ...
        extentReports = new ExtentReports(System.getProperty("user.dir") + "/result/" + TC_05_Test_SSO_Office.class.getName() + "_" + LocalDateTime.now(ZoneId.systemDefault()) + "_" + ".html", true);
