...
/*This test is for checking if user is able to SSO using Office.*/

public class TC_05_Test_SSO_Office {

    public static SignUp signUp;
    public static SuccessfulRegistration successfulRegistration;
    static ExtentReports extentReports;
    static ExtentTest extentLogger;
    Logger log = Logger.getLogger(TC_05_Test_SSO_Office.class.getName());
    ...
    public void classSetup() throws IOException {
        ...
        extentReports = new ExtentReports(System.getProperty("user.dir") + "/result/" + TC_05_Test_SSO_Office.class.getName() + "_"+ LocalDate.now() +"_"+ LocalTime.now().toString().replace(":","-") +  ".html", true);
        extentLogger = extentReports.startTest("Verify if user is able to SSO using Microsoft Office");
    ...
    @Test
    public void officeSSOTest() throws InterruptedException {
        try {
    ...
    public void verifyTitle() throws InterruptedException {
        try {
            log.info("Clicking on Office SSO button and validating title of the newly open Page");
            Assert.assertEquals(signUp.ssoOffice(), "Sign in to your account");
